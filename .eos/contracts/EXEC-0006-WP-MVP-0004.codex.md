...
Execution: EXEC-0006
Generated: 2026-08-17T01:50:05Z
Branch: `wp/mvp-0004`
Worktree: `/data/MONAD/.monad-worktrees/wp-mvp-0004`
Baseline: `87257c8060c3d08413bf5f975e2f605369340b9e`
Governing hash: `4933e2428d0dfaaa2ab315a885b60260e18a9c9896bf99453be4a3c2f2a94816`
Contract hash: `3e7c5bc8200efa48f9e3908c1ee7c6700943594f35334145d0588c57daf529b0`
...
Before finalizing work, verify this contract with `./scripts/eos contract verify EXEC-0006`. If governing inputs drift, stop: the execution contract is invalid.
...
Write JSON matching the contract to `.eos-result-EXEC-0006.json` in the worktree, then ingest it from the main repository:

`./scripts/eos execution ingest EXEC-0006 <path-to-result.json>`
