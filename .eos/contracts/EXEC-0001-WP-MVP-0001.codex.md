...
Execution: EXEC-0001
Generated: 2026-08-14T10:41:59Z
Branch: `wp/mvp-0001`
Worktree: `/data/MONAD/.monad-worktrees/wp-mvp-0001`
Baseline: `1f377fa8e86e11a7e2920e9a0c3b7cbea1437990`
Governing hash: `35ada1da5aafd4f5c1c2c20e0ee3cc2c6d6628d15b6ac87ec3e33f8bdaeb6bfa`
Contract hash: `539b225c74091e73f1c8dbbe056ac44243ecec914454e4e2dbecbc5ddbb80df4`
...
Before finalizing work, verify this contract with `./scripts/eos contract verify EXEC-0001`. If governing inputs drift, stop: the execution contract is invalid.
...
Write JSON matching the contract to `.eos-result-EXEC-0001.json` in the worktree, then ingest it from the main repository:

`./scripts/eos execution ingest EXEC-0001 <path-to-result.json>`
