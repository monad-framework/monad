...
Execution: EXEC-0007
Generated: 2026-08-17T03:25:18Z
Branch: `wp/mvp-0004`
Worktree: `/data/MONAD/.monad-worktrees/wp-mvp-0004`
Baseline: `9487abbfbbf60231a89072b4dc34faa9add8caca`
Governing hash: `4933e2428d0dfaaa2ab315a885b60260e18a9c9896bf99453be4a3c2f2a94816`
Contract hash: `0f3bf85f3df8b088ec4b441ba5fe7d4c0efa3f0afb044c9fd89cc845f21a4966`
...
Before finalizing work, verify this contract with `./scripts/eos contract verify EXEC-0007`. If governing inputs drift, stop: the execution contract is invalid.
...
Write JSON matching the contract to `.eos-result-EXEC-0007.json` in the worktree, then ingest it from the main repository:

`./scripts/eos execution ingest EXEC-0007 <path-to-result.json>`
