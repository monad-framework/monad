...
Execution: EXEC-0002
Generated: 2026-08-14T11:28:39Z
Branch: `wp/mvp-0001`
...
Contract hash: `14534d222ef71281003a624c0d93a129360b6f7030895667175690eb72ddc2d0`
...
Before finalizing work, verify this contract with `./scripts/eos contract verify EXEC-0002`. If governing inputs drift, stop: the execution contract is invalid.
...
Write JSON matching the contract to `.eos-result-EXEC-0002.json` in the worktree, then ingest it from the main repository:

`./scripts/eos execution ingest EXEC-0002 <path-to-result.json>`
