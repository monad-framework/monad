...
# WP-MVP-0019 — CLI output and error contract
...
Deliver **cli output and error contract** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-061 define exit codes.
- [ ] US-062 define structured output.
- [ ] US-063 support no-color and CI-safe output.
