...
# WP-MVP-0028 — Installation and packaging
...
Deliver **installation and packaging** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-088 provide supported installation.
- [ ] US-089 expose version identity.
- [ ] US-090 publish checksummed artifacts.
