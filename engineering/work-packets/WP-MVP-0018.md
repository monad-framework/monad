...
# WP-MVP-0018 — MVP CLI command surface

**Status:** Planned  
**Epic:** EPIC-009  
**Work Cycle / Sprint:** WC-MVP-0007  
**Product Goal:** PG-001  
**Target:** MVP Release 1

## Objective

Deliver **mvp cli command surface** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-056 implement inspect.
- [ ] US-057 implement validate.
- [ ] US-058 implement graph and query.
- [ ] US-059 implement explain.
- [ ] US-060 implement context.
