...
# WP-MVP-0027 — GitHub engineering projection

**Status:** Planned  
**Epic:** EPIC-012  
**Work Cycle / Sprint:** WC-MVP-0010  
**Product Goal:** PG-001  
**Target:** MVP Release 1

## Objective

Deliver **github engineering projection** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-085 trace Issues to Work Packets.
- [ ] US-086 emit PR semantic-summary baseline.
- [ ] US-087 define project-status projection rules.
