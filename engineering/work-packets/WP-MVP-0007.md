...
# WP-MVP-0007 — Semantic graph ontology
...
Deliver **semantic graph ontology** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-021 define MVP node types.
- [ ] US-022 define MVP edge types.
- [ ] US-023 define graph invariants.
