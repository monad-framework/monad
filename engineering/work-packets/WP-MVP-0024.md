...
# WP-MVP-0024 — Native validation adapter

**Status:** Planned  
**Epic:** EPIC-011  
**Work Cycle / Sprint:** WC-MVP-0009  
**Product Goal:** PG-001  
**Target:** MVP Release 1

## Objective

Deliver **native validation adapter** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-076 define validation capability contract.
- [ ] US-077 preserve invocation evidence.
- [ ] US-078 preserve native tool results.
