...
# WP-MVP-0015 — Work Packet semantic contract
...
Deliver **work packet semantic contract** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-046 parse canonical Work Packets.
- [ ] US-047 validate authority and scope.
- [ ] US-048 identify acceptance and validation commands.
