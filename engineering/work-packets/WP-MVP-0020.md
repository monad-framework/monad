...
# WP-MVP-0020 — Doctor completion and onboarding
...
Deliver **doctor completion and onboarding** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-064 implement doctor.
- [ ] US-065 provide shell completion.
- [ ] US-066 provide actionable first-run help.
