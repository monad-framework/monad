...
# WP-MVP-0025 — Semantic diff and impact baseline
...
Deliver **semantic diff and impact baseline** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-079 diff semantic graph state.
- [ ] US-080 identify affected entities.
- [ ] US-081 recommend validation scope.
