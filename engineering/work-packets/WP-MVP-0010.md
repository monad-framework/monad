...
# WP-MVP-0010 — KIR schema and canonicalization
...
Deliver **kir schema and canonicalization** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-030 define MVP KIR schema.
- [ ] US-031 canonicalize serialization.
- [ ] US-032 expose KIR version.
- [ ] US-033 validate KIR.
