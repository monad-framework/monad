...
# WP-MVP-0014 — Explain relationship paths

**Status:** Planned  
**Epic:** EPIC-007  
**Work Cycle / Sprint:** WC-MVP-0005  
**Product Goal:** PG-001  
**Target:** MVP Release 1

## Objective

Deliver **explain relationship paths** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-043 explain why an entity exists.
- [ ] US-044 explain governing paths.
- [ ] US-045 distinguish missing knowledge from negative answers.
