...
# WP-MVP-0030 — Release provenance
...
Deliver **release provenance** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-094 produce source-artifact manifest.
- [ ] US-095 produce SBOM baseline.
- [ ] US-096 produce reproducible release evidence.
