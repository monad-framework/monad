...
# WP-MVP-0012 — Semantic validation engine
...
Deliver **semantic validation engine** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-037 evaluate validation rules.
- [ ] US-038 validate authority and references.
- [ ] US-039 emit deterministic findings.
