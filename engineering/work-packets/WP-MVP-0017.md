...
# WP-MVP-0017 — Agent context package

**Status:** Planned  
**Epic:** EPIC-008  
**Work Cycle / Sprint:** WC-MVP-0006  
**Product Goal:** PG-001  
**Target:** MVP Release 1

## Objective

Deliver **agent context package** as one independently reviewable vertical engineering outcome that advances PG-001 without expanding beyond the MVP boundary.
...
- [ ] US-052 serialize deterministic context package.
- [ ] US-053 provide Codex profile.
- [ ] US-054 minimize secrets and irrelevant data.
- [ ] US-055 retain context provenance.
