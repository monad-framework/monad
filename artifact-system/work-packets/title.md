...
**Catalog path:** `artifact-system/work-packets/title.md`  
**Status:** Draft  
...
The **Title** artifact makes title explicit and reviewable within Monad. It exists to prevent important work packets decisions from living only in chat, memory, implementation detail, or tool-specific state.
