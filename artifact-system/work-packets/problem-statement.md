...
**Catalog path:** `artifact-system/work-packets/problem-statement.md`  
**Status:** Draft  
...
The **Problem Statement** artifact makes problem statement explicit and reviewable within Monad. It exists to prevent important work packets decisions from living only in chat, memory, implementation detail, or tool-specific state.
