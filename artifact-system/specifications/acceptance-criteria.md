...
**Catalog path:** `artifact-system/specifications/acceptance-criteria.md`  
**Status:** Draft  
...
The **Acceptance Criteria** artifact makes acceptance criteria explicit and reviewable within Monad. It exists to prevent important specifications decisions from living only in chat, memory, implementation detail, or tool-specific state.
