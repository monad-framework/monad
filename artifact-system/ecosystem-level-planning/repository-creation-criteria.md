...
# Repository Creation Criteria

**Catalog path:** `artifact-system/ecosystem-level-planning/repository-creation-criteria.md`  
**Status:** Draft  
...
The **Repository Creation Criteria** artifact makes repository creation criteria explicit and reviewable within Monad. It exists to prevent important ecosystem level planning decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Repository Creation Criteria when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Repository Creation Criteria includes:
