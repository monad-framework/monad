...
**Catalog path:** `artifact-system/ci-cd/provenance-generation-pipeline.md`  
**Status:** Draft  
...
The **Provenance Generation Pipeline** artifact makes provenance generation pipeline explicit and reviewable within Monad. It exists to prevent important ci cd decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Verification for an instantiated Provenance Generation Pipeline includes:
