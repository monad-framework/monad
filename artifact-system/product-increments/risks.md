...
**Catalog path:** `artifact-system/product-increments/risks.md`  
**Status:** Draft  
...
The **Risks** artifact makes risks explicit and reviewable within Monad. It exists to prevent important product increments decisions from living only in chat, memory, implementation detail, or tool-specific state.
