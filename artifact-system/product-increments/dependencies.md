...
**Catalog path:** `artifact-system/product-increments/dependencies.md`  
**Status:** Draft  
...
The **Dependencies** artifact makes dependencies explicit and reviewable within Monad. It exists to prevent important product increments decisions from living only in chat, memory, implementation detail, or tool-specific state.
