...
**Catalog path:** `artifact-system/milestones/milestone-acceptance-criteria.md`  
**Status:** Draft  
...
The **Milestone Acceptance Criteria** artifact makes milestone acceptance criteria explicit and reviewable within Monad. It exists to prevent important milestones decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Milestone Acceptance Criteria when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Milestone Acceptance Criteria includes:
