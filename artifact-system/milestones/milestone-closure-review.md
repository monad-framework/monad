...
**Catalog path:** `artifact-system/milestones/milestone-closure-review.md`  
**Status:** Draft  
...
The **Milestone Closure Review** artifact makes milestone closure review explicit and reviewable within Monad. It exists to prevent important milestones decisions from living only in chat, memory, implementation detail, or tool-specific state.
