...
**Catalog path:** `artifact-system/risk-management/impact.md`  
**Status:** Draft  
...
The **Impact** artifact makes impact explicit and reviewable within Monad. It exists to prevent important risk management decisions from living only in chat, memory, implementation detail, or tool-specific state.
