...
**Catalog path:** `artifact-system/risk-management/product-risks.md`  
**Status:** Draft  
...
The **Product Risks** artifact makes product risks explicit and reviewable within Monad. It exists to prevent important risk management decisions from living only in chat, memory, implementation detail, or tool-specific state.
