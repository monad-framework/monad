...
**Catalog path:** `artifact-system/foundational-artifacts/vision/security-principles.md`  
**Status:** Draft  
...
The **Security Principles** artifact makes security principles explicit and reviewable within Monad. It exists to prevent important foundational artifacts decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Security Principles when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Security Principles includes:
