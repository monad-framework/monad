...
**Catalog path:** `artifact-system/foundational-artifacts/vision/local-first-principles.md`  
**Status:** Draft  
...
The **Local First Principles** artifact makes local first principles explicit and reviewable within Monad. It exists to prevent important foundational artifacts decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Local First Principles when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Local First Principles includes:
