...
**Catalog path:** `artifact-system/domain/invariants.md`  
**Status:** Draft  
...
The **Invariants** artifact makes invariants explicit and reviewable within Monad. It exists to prevent important domain decisions from living only in chat, memory, implementation detail, or tool-specific state.
