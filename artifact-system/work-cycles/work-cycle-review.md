...
**Catalog path:** `artifact-system/work-cycles/work-cycle-review.md`  
**Status:** Draft  
...
The **Work Cycle Review** artifact makes work cycle review explicit and reviewable within Monad. It exists to prevent important work cycles decisions from living only in chat, memory, implementation detail, or tool-specific state.

Within the artifact catalog this document defines evidence, reviewers, findings, decision criteria, disposition, residual risk, and closure evidence. Its family focuses on short execution and learning windows that coordinate bounded work, review outcomes, risks, and adaptation. The contract is deliberately independent of a particular implementation tool so humans, ChatGPT, Codex, CI, and future Monad automation can reason about the same engineering intent.
