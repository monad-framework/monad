...
**Status:** Draft  
**Artifact class:** Work Cycles / Review Contract  
...
`artifact-system/work-cycles/work-cycle-review.md` is the human-readable canonical source for this artifact once approved. Any representation under `machine/` is a deterministic derivative and must not be edited independently.
