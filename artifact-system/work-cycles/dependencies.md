...
**Catalog path:** `artifact-system/work-cycles/dependencies.md`  
**Status:** Draft  
...
The **Dependencies** artifact makes dependencies explicit and reviewable within Monad. It exists to prevent important work cycles decisions from living only in chat, memory, implementation detail, or tool-specific state.
