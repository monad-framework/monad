...
**Catalog path:** `artifact-system/work-cycles/risks.md`  
**Status:** Draft  
...
The **Risks** artifact makes risks explicit and reviewable within Monad. It exists to prevent important work cycles decisions from living only in chat, memory, implementation detail, or tool-specific state.
