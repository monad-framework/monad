...
# Decision To Affected Artifacts

**Catalog path:** `artifact-system/traceability-artifacts/decision-to-affected-artifacts.md`  
**Status:** Draft  
...
This contract governs the structure, semantics, authority, lifecycle, traceability, and verification of Decision To Affected Artifacts records used by Monad. It does not grant decision authority, approve an implementation, or supersede higher-order governance. Tool-specific UI fields are projections unless explicitly designated canonical.
...
Verification for an instantiated Decision To Affected Artifacts includes:
