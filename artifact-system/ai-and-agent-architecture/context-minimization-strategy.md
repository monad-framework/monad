...
**Catalog path:** `artifact-system/ai-and-agent-architecture/context-minimization-strategy.md`  
**Status:** Draft  
...
This contract governs the structure, semantics, authority, lifecycle, traceability, and verification of Context Minimization Strategy records used by Monad. It does not grant decision authority, approve an implementation, or supersede higher-order governance. Tool-specific UI fields are projections unless explicitly designated canonical.
...
Verification for an instantiated Context Minimization Strategy includes:
