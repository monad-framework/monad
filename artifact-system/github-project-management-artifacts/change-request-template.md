...
**Catalog path:** `artifact-system/github-project-management-artifacts/change-request-template.md`  
**Status:** Draft  
...
The **Change Request Template** artifact makes change request template explicit and reviewable within Monad. It exists to prevent important github project management artifacts decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Change Request Template when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Change Request Template includes:
