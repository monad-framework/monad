...
**Catalog path:** `artifact-system/security-planning/trust-model.md`  
**Status:** Draft  
...
The **Trust Model** artifact makes trust model explicit and reviewable within Monad. It exists to prevent important security planning decisions from living only in chat, memory, implementation detail, or tool-specific state.
