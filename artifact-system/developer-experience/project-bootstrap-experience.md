...
**Catalog path:** `artifact-system/developer-experience/project-bootstrap-experience.md`  
**Status:** Draft  
...
The **Project Bootstrap Experience** artifact makes project bootstrap experience explicit and reviewable within Monad. It exists to prevent important developer experience decisions from living only in chat, memory, implementation detail, or tool-specific state.
...
Create or promote an instantiated Project Bootstrap Experience when an accepted decision, approved specification, active Work Packet, release gate, recurring operational need, or material risk requires a durable representation. Do not activate the artifact merely because the catalog contains this contract.
...
Verification for an instantiated Project Bootstrap Experience includes:
