...
| ---------------- | ---------- | --------------------------------------------------------------------------------- | -------------- |
| `FUN-AIENG-0001` | Functional | Adaptive engineering pathway, clarification, replanning, and workflow progression | Approved       |
| `IFC-AIENG-0001` | Interface  | Provider-neutral engineering-agent interaction contract                           | Approved       |
| `SEC-AIENG-0001` | Security   | Autonomy, authority, delegation, approval, revocation, and fail-closed boundaries | Approved       |
